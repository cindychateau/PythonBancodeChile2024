...
class User:
    ...
    def save(cls, form):
        ...
        return connectToMySQL("events_bc").query_db(query, form) #Regresar el ID del nuevo registro
    ...
    def get_by_email(cls, form): #cls = User
        ...
        result = connectToMySQL("events_bc").query_db(query, form) #Regresa Lista de Diccionarios
    ...
    def validate_user(form):
        ...
        query = "SELECT * FROM users WHERE email = %(email)s"
        result = connectToMySQL("events_bc").query_db(query, form) #Lista de diccionarios
    ...
    def get_by_id(cls, data):
        ...
        result = connectToMySQL('events_bc').query_db(query, data) #Lista de 1 diccionario -> indice 0
        user = cls(result[0])
        return user
